...
const (
	...
	RecipeFavoriteFields_CircleId         = "circle_id"
...
type RecipeFavorite struct {
	...
	RecipeId         int64     `gorm:"not null;index;uniqueIndex:idx_recipe_id_user_id_circle_id"`
	UserId           int64     `gorm:"index;uniqueIndex:idx_recipe_id_user_id_circle_id"`
	CircleId         int64     `gorm:"index;uniqueIndex:idx_recipe_id_user_id_circle_id"`
