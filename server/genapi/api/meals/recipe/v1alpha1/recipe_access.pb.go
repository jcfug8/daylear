...
type AcceptRecipeAccessResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AcceptRecipeAccessResponse) Reset() {
	*x = AcceptRecipeAccessResponse{}
	mi := &file_api_meals_recipe_v1alpha1_recipe_access_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AcceptRecipeAccessResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcceptRecipeAccessResponse) ProtoMessage() {}

func (x *AcceptRecipeAccessResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_meals_recipe_v1alpha1_recipe_access_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcceptRecipeAccessResponse.ProtoReflect.Descriptor instead.
func (*AcceptRecipeAccessResponse) Descriptor() ([]byte, []int) {
	return file_api_meals_recipe_v1alpha1_recipe_access_proto_rawDescGZIP(), []int{8}
}
...
func (x *Access_RequesterOrRecipient) Reset() {
	*x = Access_RequesterOrRecipient{}
	mi := &file_api_meals_recipe_v1alpha1_recipe_access_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_api_meals_recipe_v1alpha1_recipe_access_proto_rawDesc = "" +
	...
	"\raccept_target\x18\x06 \x01(\x0e2\x17.api.types.AcceptTargetB\x03\xe0A\x03R\facceptTarget\x1a\xa0\x01\n" +
	...
	"\x1aAcceptRecipeAccessResponse2\xa5\x12\n" +
	"\x13RecipeAccessService\x12\xf6\x02\n" +
	"\fCreateAccess\x12..api.meals.recipe.v1alpha1.CreateAccessRequest\x1a!.api.meals.recipe.v1alpha1.Access\"\x92\x02\x92A\x82\x01\n" +
	"\x13RecipeAccessService\x12)Grant a user or circle access to a recipe\x1a@Grants a user or circle a specific permission level to a recipe.\xdaA\rparent,access\x82\xd3\xe4\x93\x02v:\x06accessZ?:\x06access\"5/meals/v1alpha1/{parent=circles/*/recipes/*}/accesses\"+/meals/v1alpha1/{parent=recipes/*}/accesses\x12\xae\x02\n" +
	"\fDeleteAccess\x12..api.meals.recipe.v1alpha1.DeleteAccessRequest\x1a\x16.google.protobuf.Empty\"\xd5\x01\x92A_\n" +
	"\x13RecipeAccessService\x12\x16Delete a recipe access\x1a0Removes a user's or circle's access to a recipe.\xdaA\x04name\x82\xd3\xe4\x93\x02fZ7*5/meals/v1alpha1/{name=circles/*/recipes/*/accesses/*}*+/meals/v1alpha1/{name=recipes/*/accesses/*}\x12\xb1\x02\n" +
	"\tGetAccess\x12+.api.meals.recipe.v1alpha1.GetAccessRequest\x1a!.api.meals.recipe.v1alpha1.Access\"\xd3\x01\x92A]\n" +
	"\x13RecipeAccessService\x12\x13Get a recipe access\x1a1Retrieves details about a specific recipe access.\xdaA\x04name\x82\xd3\xe4\x93\x02fZ7\x125/meals/v1alpha1/{name=circles/*/recipes/*/accesses/*}\x12+/meals/v1alpha1/{name=recipes/*/accesses/*}\x12\xd5\x03\n" +
	"\fListAccesses\x12..api.meals.recipe.v1alpha1.ListAccessesRequest\x1a/.api.meals.recipe.v1alpha1.ListAccessesResponse\"\xe3\x02\x92A\xea\x01\n" +
	"\x13RecipeAccessService\x12\x14List recipe accesses\x1a\xbc\x01Lists all users and circles with access to a recipe. If no recipe is provided, the response will only return the accesses for the current user (or circle if the circle header is provided).\xdaA\x06parent\x82\xd3\xe4\x93\x02fZ7\x125/meals/v1alpha1/{parent=circles/*/recipes/*}/accesses\x12+/meals/v1alpha1/{parent=recipes/*}/accesses\x12\xf4\x02\n" +
	"\fUpdateAccess\x12..api.meals.recipe.v1alpha1.UpdateAccessRequest\x1a!.api.meals.recipe.v1alpha1.Access\"\x90\x02\x92Am\n" +
	"\x13RecipeAccessService\x12\x16Update a recipe access\x1a>Updates the permission level or recipient for a recipe access.\xdaA\x12access,update_mask\x82\xd3\xe4\x93\x02\x84\x01:\x06accessZF:\x06access2</meals/v1alpha1/{access.name=circles/*/recipes/*/accesses/*}22/meals/v1alpha1/{access.name=recipes/*/accesses/*}\x12\x8a\x03\n" +
	"\x12AcceptRecipeAccess\x124.api.meals.recipe.v1alpha1.AcceptRecipeAccessRequest\x1a5.api.meals.recipe.v1alpha1.AcceptRecipeAccessResponse\"\x86\x02\x92A|\n" +
	"\x13RecipeAccessService\x12\x16Accept a recipe access\x1aMAccepts a pending recipe access, changing its state from PENDING to ACCEPTED.\xdaA\x04name\x82\xd3\xe4\x93\x02z:\x01*ZA:\x01*\"</meals/v1alpha1/{name=circles/*/recipes/*/accesses/*}:accept\"2/meals/v1alpha1/{name=recipes/*/accesses/*}:accept\x1aT\x92AQ\x12\x18Recipe Access management\x1a5\n" +
...
var file_api_meals_recipe_v1alpha1_recipe_access_proto_depIdxs = []int32{
	...
	14, // 4: api.meals.recipe.v1alpha1.Access.accept_target:type_name -> api.types.AcceptTarget
	0,  // 5: api.meals.recipe.v1alpha1.CreateAccessRequest.access:type_name -> api.meals.recipe.v1alpha1.Access
	0,  // 6: api.meals.recipe.v1alpha1.ListAccessesResponse.accesses:type_name -> api.meals.recipe.v1alpha1.Access
	0,  // 7: api.meals.recipe.v1alpha1.UpdateAccessRequest.access:type_name -> api.meals.recipe.v1alpha1.Access
	15, // 8: api.meals.recipe.v1alpha1.UpdateAccessRequest.update_mask:type_name -> google.protobuf.FieldMask
	10, // 9: api.meals.recipe.v1alpha1.Access.RequesterOrRecipient.user:type_name -> api.meals.recipe.v1alpha1.Access.User
	11, // 10: api.meals.recipe.v1alpha1.Access.RequesterOrRecipient.circle:type_name -> api.meals.recipe.v1alpha1.Access.Circle
	1,  // 11: api.meals.recipe.v1alpha1.RecipeAccessService.CreateAccess:input_type -> api.meals.recipe.v1alpha1.CreateAccessRequest
	2,  // 12: api.meals.recipe.v1alpha1.RecipeAccessService.DeleteAccess:input_type -> api.meals.recipe.v1alpha1.DeleteAccessRequest
	3,  // 13: api.meals.recipe.v1alpha1.RecipeAccessService.GetAccess:input_type -> api.meals.recipe.v1alpha1.GetAccessRequest
	4,  // 14: api.meals.recipe.v1alpha1.RecipeAccessService.ListAccesses:input_type -> api.meals.recipe.v1alpha1.ListAccessesRequest
	6,  // 15: api.meals.recipe.v1alpha1.RecipeAccessService.UpdateAccess:input_type -> api.meals.recipe.v1alpha1.UpdateAccessRequest
	7,  // 16: api.meals.recipe.v1alpha1.RecipeAccessService.AcceptRecipeAccess:input_type -> api.meals.recipe.v1alpha1.AcceptRecipeAccessRequest
	0,  // 17: api.meals.recipe.v1alpha1.RecipeAccessService.CreateAccess:output_type -> api.meals.recipe.v1alpha1.Access
	16, // 18: api.meals.recipe.v1alpha1.RecipeAccessService.DeleteAccess:output_type -> google.protobuf.Empty
	0,  // 19: api.meals.recipe.v1alpha1.RecipeAccessService.GetAccess:output_type -> api.meals.recipe.v1alpha1.Access
	5,  // 20: api.meals.recipe.v1alpha1.RecipeAccessService.ListAccesses:output_type -> api.meals.recipe.v1alpha1.ListAccessesResponse
	0,  // 21: api.meals.recipe.v1alpha1.RecipeAccessService.UpdateAccess:output_type -> api.meals.recipe.v1alpha1.Access
	8,  // 22: api.meals.recipe.v1alpha1.RecipeAccessService.AcceptRecipeAccess:output_type -> api.meals.recipe.v1alpha1.AcceptRecipeAccessResponse
...
func file_api_meals_recipe_v1alpha1_recipe_access_proto_init() {
	...
	file_api_meals_recipe_v1alpha1_recipe_access_proto_msgTypes[9].OneofWrappers = []any{
