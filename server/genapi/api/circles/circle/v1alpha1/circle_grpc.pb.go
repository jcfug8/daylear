...
const (
	...
	CircleService_ShareCircle_FullMethodName  = "/api.circles.circle.v1alpha1.CircleService/ShareCircle"
)
...
type CircleServiceClient interface {
	...
	// share a circle
	ShareCircle(ctx context.Context, in *ShareCircleRequest, opts ...grpc.CallOption) (*ShareCircleResponse, error)
}
...
func (c *circleServiceClient) ShareCircle(ctx context.Context, in *ShareCircleRequest, opts ...grpc.CallOption) (*ShareCircleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShareCircleResponse)
	err := c.cc.Invoke(ctx, CircleService_ShareCircle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CircleServiceServer interface {
	...
	// share a circle
	ShareCircle(context.Context, *ShareCircleRequest) (*ShareCircleResponse, error)
...
func (UnimplementedCircleServiceServer) ShareCircle(context.Context, *ShareCircleRequest) (*ShareCircleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ShareCircle not implemented")
}
...
func _CircleService_ShareCircle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShareCircleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CircleServiceServer).ShareCircle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CircleService_ShareCircle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CircleServiceServer).ShareCircle(ctx, req.(*ShareCircleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CircleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ShareCircle",
			Handler:    _CircleService_ShareCircle_Handler,
		},
	},
