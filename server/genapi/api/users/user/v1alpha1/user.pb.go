...
type User_Access struct {
	...
	AcceptTarget  types.AcceptTarget `protobuf:"varint,5,opt,name=accept_target,json=acceptTarget,proto3,enum=api.types.AcceptTarget" json:"accept_target,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *User_Access) GetAcceptTarget() types.AcceptTarget {
	if x != nil {
...
const file_api_users_user_v1alpha1_user_proto_rawDesc = "" +
	...
	"\x05state\x18\x04 \x01(\x0e2\x16.api.types.AccessStateB\x03\xe0A\x03R\x05state\x12A\n" +
	"\raccept_target\x18\x05 \x01(\x0e2\x17.api.types.AcceptTargetB\x03\xe0A\x03R\facceptTarget:v\xeaAs\n" +
