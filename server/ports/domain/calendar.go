...
type calendarDomain interface {
	...
	GetCalendarAccess(ctx context.Context, authAccount model.AuthAccount, parent model.CalendarAccessParent, id model.CalendarAccessId) (model.CalendarAccess, error)
	...
	UpdateCalendarAccess(ctx context.Context, authAccount model.AuthAccount, access model.CalendarAccess, updateMask []string) (model.CalendarAccess, error)
