...
type calendarClient interface {
	...
	DeleteCalendar(ctx context.Context, authAccount model.AuthAccount, id model.CalendarId) (model.Calendar, error)
	GetCalendar(ctx context.Context, authAccount model.AuthAccount, id model.CalendarId) (model.Calendar, error)
